<template>
  <div class="text-container projects">
    <div class="projects-top">
      <h2>My work</h2>
      <button class="projects-layout-switcher" @click="switchMode" v-if="mode">
        +
      </button>
    </div>
    <div v-if="mode" class="carousell">
      ...
      <div class="carousell-content">
        <img
          v-if="!items[index].video && items[index].img"
          :alt="items[index].title + ' image'"
          class="carousell-img"
          :src="items[index].img"
        />
        <iframe
          v-else-if="items[index].video && items[index].img"
          width="100%"
          class="carousell-img"
        ...
        <div class="carousell-content-text">
          ...
          <a v-if="items[index].url" :href="items[index].url">{{
            items[index].urlText
          }}</a>
      ...
      items: [
        {
          title: "Wipit Board",
          desc: `
          Application developed by a team of 8 for a real client as Henry's Final Project. Wipit is a social network for programmers, by programmers.
          It's a global backlog where anyone can post a task/question and another person can reach to him via live chat and start pair programming.
          Although everyone helped with most features, my biggest contributions were all login/register functionalities,
        ...
        },
        {
          ...
          desc: `
          My very first project deployed on the Solana Blockchain! 
        ...
        },
        {
          ...
          \nIt started as a small commandline project for my father, but I quickly realized that a CLI python app is not very user friendly , and quite hard to package for different 
        ...
        // },
        {
          title: "Pokemon Index",
          desc: `
          Fullstack app developed completely on my own with all the different technologies learned throughout the Henry Bootcamp.
          ...
          urlText: "Contact me if interested in checking the code",
        },
      ],
      index: 0,
      mode: false,
